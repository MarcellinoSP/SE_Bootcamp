...
class Program
{
	static void Main()
	{
		...
		MobilePhone Samsung = new(amoledScreen, snapdragonProcie);
		Samsung.RunPhone();
		Console.WriteLine("\n");
		//End of Samsung Phone
		MobilePhone Xiaomi = new(IPSScreen, snapdragonProcie);
		Xiaomi.RunPhone();
		Console.WriteLine("\n");
		//End of Xiaomi Phone
		MobilePhone IPhone = new(retinaScreen, binoicProcie);
		IPhone.RunPhone();
		Console.WriteLine("\n");
		//End of Iphone
	}
